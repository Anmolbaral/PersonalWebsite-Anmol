...
export const profile = {
  ...
  about:
    'I’m an AI engineer who cares as much about AI safety, guardrails, evaluation, and recoverability as model capability. I build multi-agent and retrieval systems in Python and FastAPI, and I’ve also shipped firmware at Apple, campus infrastructure at Vanderbilt, and education platforms used across 12+ countries.',
...
export const projects: Project[] = [
  {
    ...
    title: 'ControlPanel',
    summary:
      'A real-estate-focused agent orchestration platform that coordinates agent work through typed tools, skills, persistent state, and deny-by-default guardrails for safe, recoverable operation.',
    role: 'AI engineer',
  ...
  },
  {
    ...
    summary:
      'A non-UI stateful multi-agent system for conversation routing, persistent history, rate limiting, parallel workers, and hybrid retrieval.',
  ...
  },
  {
    ...
    summary:
      'A learning platform with FERPA/COPPA-compliant retrieval across 68+ curated sources, multi-role access, and instructor analytics.',
  ...
  },
  {
    ...
    impact: '200+ engineers unblocked · ~90 engineer-hours/week recovered',
  },
];
